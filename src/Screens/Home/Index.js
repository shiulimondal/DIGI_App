    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.top_view}>
          <Icon name='alpha-h-circle' type='MaterialCommunityIcon' size={26} color={Colors.secondaryFont} />
          <Text style={styles.user_name}>Hapij Mahammad Khan</Text>
          <Text style={styles.user_id}> ID - 14454221</Text>
        </View>
        <View>
